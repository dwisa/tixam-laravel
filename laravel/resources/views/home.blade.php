...
@section('content')
  ...
  @if(Auth::user()->status == 'A')
    <div class="callout callout-info">
      ...
      <p>Anda adalah admin aplikasi ini. Selalu pantau <a href="https://aplikasipendidikan.net/" target="_blank">Aplikasi Pendidikan</a> untuk mendapatkan update terbaru. Dan yuk ajak guru-guru menjadi kontributor <a href="http://ayosinau.com">Ayosinau.com</a>.</p>
    </div>
  @endif
